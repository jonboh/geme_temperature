...
--
--
--  File 'k-mutexes-attributes_srp.ads'                                By MAR.
--
--
...
--
------------------------------------------------------------------------------
package MaRTE.Kernel.Mutexes.Attributes_SRP is
   ...
   pragma Export (C, Pthread_Mutexattr_Setpreemptionlevel,
   ...
   pragma Export (C, Pthread_Mutexattr_Getpreemptionlevel,
